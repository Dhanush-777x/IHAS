...
const MedicalCenters = () => {
  ...
  useEffect(() => {
    ...
    googleMapScript.src = `https://maps.googleapis.com/maps/api/js?key=AI&libraries=places`;
  ...
  return (
    <div className="">
      ...
      <h1 className='medical-centers-section-heading mb-3'>Search for Nearby Medical Centers</h1>
      <input
      className='location-search-input p-3'
        type="text"
        value={searchQuery}
